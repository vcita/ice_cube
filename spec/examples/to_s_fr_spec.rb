...
describe IceCube::Schedule, 'to_s' do
  ...
  it 'should work with various sentence types properly' do
    IceCube::Rule.weekly.to_s.should == 'chaque semaine'
    IceCube::Rule.weekly.day(:monday).to_s.should == 'chaque semaine le lundi'
    IceCube::Rule.weekly.day(:monday, :tuesday).to_s.should == 'chaque semaine le lundi et mardi'
    IceCube::Rule.weekly.day(:monday, :tuesday, :wednesday).to_s.should == 'chaque semaine le lundi, mardi, et mercredi'
  end
  ...
  it 'should not show weekdays as such when a weekend day is present' do
    IceCube::Rule.weekly.day(
      ...
      :thursday, :friday
    ).to_s.should == 'chaque semaine le dimanche, lundi, mardi, mercredi, jeudi, et vendredi'
  end
  ...
  it 'should be able to say the last Thursday of the month' do
    ...
    rule_str.should == 'chaque mois en dernier jeudi'
  end
  ...
  it 'should be able to say what minute of an hour something happens - with special suffix minutes' do
    ...
    rule_str.should == 'chaque heure aux minutes 10e, 11er, 12e, 13e, 14e, et 15e de chaque heure'
  end
  ...
  it 'should be able to say what seconds of the minute something happens' do
    ...
    rule_str.should == 'chaque minute aux secondes 10e et 11er de chaque minutes'
  end

  it 'should be able to reflect until dates' do
    schedule = IceCube::Schedule.new(Time.now)
    schedule.rrule IceCube::Rule.weekly.until(Time.local(2012, 2, 3))
    schedule.to_s.should == "chaque semaine jusqu'à 3 février, 2012"
  end
