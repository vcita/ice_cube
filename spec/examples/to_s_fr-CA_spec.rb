...
describe IceCube::Schedule, 'to_s' do
  ...
  it 'should have a useful base to_s representation for a hourly rule' do
    ...
    IceCube::Rule.hourly(2).to_s.should == 'aux 2 heures'
  end
  ...
  it 'should have a useful base to_s representation for a weekly rule' do
    ...
    IceCube::Rule.weekly(2).to_s.should == 'aux 2 semaines'
  end

  it 'should have a useful base to_s representation for a monthly rule' do
    IceCube::Rule.monthly.to_s.should == 'chaque mois'
    IceCube::Rule.monthly(2).to_s.should == 'aux 2 mois'
  end

  it 'should have a useful base to_s representation for a yearly rule' do
    IceCube::Rule.yearly.to_s.should == 'chaque année'
    IceCube::Rule.yearly(2).to_s.should == 'aux 2 ans'
  end

  it 'should work with various sentence types properly' do
    IceCube::Rule.weekly.to_s.should == 'chaque semaine'
    IceCube::Rule.weekly.day(:monday).to_s.should == 'chaque semaine les lundi'
    IceCube::Rule.weekly.day(:monday, :tuesday).to_s.should == 'chaque semaine les lundi et mardi'
    IceCube::Rule.weekly.day(:monday, :tuesday, :wednesday).to_s.should == 'chaque semaine les lundi, mardi et mercredi'
  end

  it 'should show saturday and sunday as weekends' do
    IceCube::Rule.weekly.day(:saturday, :sunday).to_s.should == 'chaque semaine les fins de semaines'
  end
  ...
  it 'should not show weekdays as such when a weekend day is present' do
    IceCube::Rule.weekly.day(
      ...
      :thursday, :friday
    ).to_s.should == 'chaque semaine les dimanche, lundi, mardi, mercredi, jeudi et vendredi'
  end
  ...
  it 'should work with rules and times and exception times' do
    ...
    schedule.to_s.should == 'chaque semaine, excepté le 20 mars 2010 et 21 mars 2010'
  end
  ...
  it 'should join the first and last weekdays of the month' do
    ...
    rule_str.should == 'chaque mois le 1er jeudi et dernier jeudi'
  end
  ...
  it 'should be able to say what minute of an hour something happens - with special suffix minutes' do
    ...
    rule_str.should == 'chaque heure à la 10e, 11e, 12e, 13e, 14e et 15e minute de l’heure'
  end
  ...
  it 'should be able to say what seconds of the minute something happens' do
    ...
    rule_str.should == 'chaque minute à la 10e et 11e seconde de la minute'
  end
