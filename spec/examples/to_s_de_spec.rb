...
describe IceCube::Schedule, 'to_s' do
  ...
  it 'should represent its start time by default' do
    ...
    IceCube::Schedule.new(t0).to_s.should == 'Februar 14, 2013'
  end
  ...
  it 'should have a useful base to_s representation for a daily rule' do
    ...
    IceCube::Rule.daily(2).to_s.should == 'Jeden 2 Tag'
  end
  ...
  it 'should work with various sentence types properly' do
    IceCube::Rule.weekly.to_s.should == 'Wöchentlich'
    IceCube::Rule.weekly.day(:monday).to_s.should == 'Wöchentlich an Montags'
    IceCube::Rule.weekly.day(:monday, :tuesday).to_s.should == 'Wöchentlich an Montags und Diensags'
    IceCube::Rule.weekly.day(:monday, :tuesday, :wednesday).to_s.should == 'Wöchentlich an Montags, Diensags, und Mittwochs'
  end
  ...
  it 'should not show weekdays as such when a weekend day is present' do
    IceCube::Rule.weekly.day(
      ...
      :thursday, :friday
    ).to_s.should == 'Wöchentlich an Sonntags, Montags, Diensags, Mittwochs, Donnerstags, und Freitags'
  end

  it 'should show start time for an empty schedule' do
    schedule = IceCube::Schedule.new Time.local(2010, 3, 20)
    schedule.to_s.should == "März 20, 2010"
  end
  ...
  it 'should work with rules and dates' do
    ...
    schedule.to_s.should == 'März 20, 2010 / Wöchentlich'
  end
  ...
  it 'should work with rules and times and exception times' do
    ...
    schedule.to_s.should == 'Wöchentlich / nicht an März 20, 2010 / nicht an März 21, 2010'
  end
  ...
  it 'should be able to say what months of the year something happens' do
    ...
    rule_str.should == 'Jährlich in Juni und Juli'
  end
  ...
  it 'should be able to say the second to last monday of the month' do
    ...
    rule_str.should == 'Monatlich am vorletzter Donnerstag'
  end
  ...
  it 'should be able to say what hour of the day something happens' do
    ...
    rule_str.should == 'Täglich an den Stunden 6. und 12. des Tages'
  end
  ...
  it 'should be able to say what minute of an hour something happens - with special suffix minutes' do
    ...
    rule_str.should == 'Stündlich an den Minuten 10., 11., 12., 13., 14., und 15. der Stunde'
  end
